...
<head runat="server">
    ...
    <!-- Data table CSS -->
    <link href="../Styles/RTL_Theme/vendors/bower_components/datatables/media/css/jquery.dataTables.min.css" rel="stylesheet" type="text/css" />

    <!-- Custom CSS -->
    <link href="../Styles/RTL_Theme/dist/css/style.css" rel="stylesheet" type="text/css">
</head>
<body>
    <form id="form1" runat="server">
                                        ...
                                        <div class="sl-item">
                                            <a href="javascript:void(0)">
                                                ...
                                                <div class="sl-content">
                                                    <span class="inline-block capitalize-font  pull-left truncate head-notifications">New subscription created
                                                    </span>
        ...
        <!-- JavaScript -->
        <!-- jQuery -->
        <script src="../Styles/RTL_Theme/vendors/bower_components/jquery/dist/jquery.min.js"></script>
        <script src="../Styles/RTL_Theme/vendors/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
        <script src="../Styles/RTL_Theme/vendors/bower_components/datatables/media/js/jquery.dataTables.min.js"></script>
        <script src="../Styles/RTL_Theme/dist/js/dataTables-data.js"></script>
        <script src="../Styles/RTL_Theme/dist/js/jquery.slimscroll.js"></script>
        <script src="../Styles/RTL_Theme/vendors/bower_components/owl.carousel/dist/owl.carousel.min.js"></script>
        <script src="../Styles/RTL_Theme/vendors/bower_components/switchery/dist/switchery.min.js"></script>
        <script src="../Styles/RTL_Theme/dist/js/dropdown-bootstrap-extended.js"></script>
        <script src="../Styles/RTL_Theme/dist/js/init.js"></script>
