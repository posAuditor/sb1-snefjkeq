<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="Loan.aspx.cs" Inherits="Loans_Loan" %>
        ...
        <div class="InvoiceSection">
            <div class="form" style="width: 90%; margin: auto;">
                <div class="right_col">
                    ...
                    <asp:ABFTextBox ID="txtReceivingDate" runat="server" ValidationGroup="Calc" LabelText="<%$Resources:Labels,ReceivingDate %>"
                        OnTextChanged="ClearInstallments" AutoPostBack="true" DataType="Date" IsRequired="true"></asp:ABFTextBox>
                    <asp:AutoComplete runat="server" ID="acBank" ServiceMethod="GetChartOfAccountsCheledronly" ValidationGroup="Save"
                        IsRequired="true" LabelText="<%$Resources:Labels,Bank %>"></asp:AutoComplete>
                    <asp:ABFTextBox ID="txtLoanNumber" runat="server" ValidationGroup="Save" LabelText="<%$Resources:Labels,LoanNumber %>"
                    ...
                    <asp:ABFTextBox ID="txtExpenses" runat="server" ValidationGroup="Save" LabelText="<%$Resources:Labels,Expenses %>"
                        DataType="Decimal" IsRequired="true" MinValue="0"></asp:ABFTextBox>
                    <asp:ABFTextBox ID="txtPeriod" runat="server" ValidationGroup="Calc" LabelText="<%$Resources:Labels,Period %>"
                        DataType="Int" IsRequired="true" OnTextChanged="ClearInstallments" AutoPostBack="true"
                        MinValue="1"></asp:ABFTextBox>
                    <label>
                        <%= Resources.Labels.PeriodType %>
                    </label>
                    <asp:DropDownList ID="ddlPeriodType" runat="server" OnSelectedIndexChanged="ClearInstallments"
                        AutoPostBack="true">
                    ...
                    <asp:ABFTextBox ID="txtPayEvery" runat="server" ValidationGroup="Calc" LabelText="<%$Resources:Labels,PayInstallmentEvery %>"
                ...
                <div class="left_col">
                    ...
                    <asp:ABFTextBox ID="txtBenefit" runat="server" ValidationGroup="Calc" LabelText="<%$Resources:Labels,LoanBenefit %>"
                        DataType="Decimal" IsRequired="true" OnTextChanged="ClearInstallments" AutoPostBack="true"
                        MinValue="0"></asp:ABFTextBox>
                    <label>
                        <%= Resources.Labels.BenefitType%>
                    </label>
                    <asp:DropDownList ID="ddlBenefitType" runat="server" OnSelectedIndexChanged="ClearInstallments"
                        AutoPostBack="true">
                        <asp:ListItem Text="<%$ Resources:Labels,Simple %>" Value="0"></asp:ListItem>
                        <asp:ListItem Text="<%$ Resources:Labels,Decreasing %>" Value="1"></asp:ListItem>
                    </asp:DropDownList>
                    <asp:ABFTextBox ID="txtStartDate" runat="server" ValidationGroup="Calc" LabelText="<%$Resources:Labels,StartDate %>"
                        DataType="Date" IsRequired="true" OnTextChanged="ClearInstallments" AutoPostBack="true"></asp:ABFTextBox>
                    ...
                    <asp:AutoComplete runat="server" ID="acExpensesCostCenter" ServiceMethod="GetCostCenters"
                        LabelText="<%$Resources:Labels,ExpensesCostCenter %>" IsHideable="true"></asp:AutoComplete>
        ...
        <div class="InvoiceSection">
            <asp:ABFGridView runat="server" ID="gvDetails" GridViewStyle="GrayStyle" DataKeyNames="ID"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Benefit" HeaderText="<%$Resources:Labels,Benefit %>" DataFormatString="{0:0.####}" />
