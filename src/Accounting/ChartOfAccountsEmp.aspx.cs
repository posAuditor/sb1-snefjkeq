...
public partial class Accounting_ChartOfAccountsEmp : UICulturePage
{
    ...
    private void FillCOATree()
    {
        ...
        var settingsChartOdAccount = dc.usp_Company_Select().FirstOrDefault();
       ...
       DataTable dtCOA = dc.usp_ChartOfAccountTreeCustom_Select(this.MyContext.CurrentCulture.ToByte(), MyContext.UserProfile.Branch_ID, settingsChartOdAccount.HRAccruedSalariesAccountID).CopyToDataTable();
