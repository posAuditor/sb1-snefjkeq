<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ChartOfAccountsAssets.aspx.cs" Inherits="Accounting_ChartOfAccountsAssets" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    <asp:LinkButton ID="lnkAddNewAccount" runat="server" CssClass="collapse_add_link" Visible="false" Style="display: none"
