<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ChartOfAccounts.aspx.cs" Inherits="Accounting_ChartOfAccounts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
      ...
      <asp:TextBox ID="ValueText" runat="server" Text=""
        Width="10%"></asp:TextBox>

    <asp:Button ID="Submit" runat="server" OnClick="Submit_Click" Text="Find Node" />


    <span style="padding-left: 20px; padding-right: 20px;">
        <asp:DropDownList ID="DropTreeLevel"
            Width="60"
            AutoPostBack="true"
            CssClass="mydropdownlist"
            OnSelectedIndexChanged="DropTreeLevel_SelectedIndexChanged"
            Style="color: #040404!important; font-size: 14px; padding: 5px 10px; border-radius: 0px; background-color: #fff; font-weight: bold; height: 34px; color: red;"
            runat="server">
            <asp:ListItem Text="2" Selected="True" Value="2"></asp:ListItem>
        ...
        <div class="content">
            <div class="form" style="width: 98%; margin: auto;">
                <div class="right_col">
                    ...
                    <asp:AutoComplete runat="server" ID="acParentAccount" ServiceMethod="GetChartOfAccountsFatheronly"
    ...
    <script type="text/javascript">
        ...
        function postBackByObject(accountNameAR, accountNameEN, id, branch, parentAccount, Currency, openBalance, StartFrom, isMain) {
            //if (id != 0) {

            $("#cph_ddlType").val(isMain);
