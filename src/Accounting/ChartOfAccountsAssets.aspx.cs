...
public partial class Accounting_ChartOfAccountsAssets : UICulturePage
{
    ...
    private void FillCOATree()
    {
        ...
        DataTable dtCOA = dc.usp_ChartOfAccountTreeCustom_Select(this.MyContext.CurrentCulture.ToByte(), MyContext.UserProfile.Branch_ID, 5).CopyToDataTable();
