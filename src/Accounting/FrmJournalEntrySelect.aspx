<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmJournalEntrySelect.aspx.cs" Inherits="Accounting_FrmJournalEntrySelect" %>
    ...
    <script>
        ...
        function refreshData() {
            var p = null, currency = null, status = null, branch = null,
                searchText = '', operationType=null, debitAccount = null, creditAccount = null,
            ...
            if (jqVar("#acOperationType").dxSelectBox('instance').option('value') != null)
            ...
            var customDataSource = new DevExpress.data.CustomStore({
                ...
                load: function (loadOptions) {
                    ...
                    jqVar.post('../api/JournalEntry/Search', {
                        'p': p, 'Currency': currency, 'Status': status, 'Branch': branch, 'SearchText': searchText, 'OperationType': operationType,
                        'DateFrom': dateFrom, 'DateTo': dateTo,'BillNo': billNo, 'CurrentCulture': preferedCulture, 'requestCode': requestCode,
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="pnlSearch" class="dx-viewport" style="display:none">
            <div class="row">
                <div class="col-md-3">
            ...
            <div class="row">                
                ...
                <div class="col-md-3">
                    <label runat="server" id="Label10"><%=Resources.Labels.Type %></label>
