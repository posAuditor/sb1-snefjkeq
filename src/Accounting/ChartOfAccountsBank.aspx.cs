...
public partial class Accounting_ChartOfAccountsBank : UICulturePage
{
    ...
    private void FillCOATree()
    {
       ...
       // DataTable dtCOA = dc.usp_ChartOfAccountTree_Select(this.MyContext.CurrentCulture.ToByte(), MyContext.UserProfile.Branch_ID).Where(x => x.ParentId == COA.Banks.ToInt()).CopyToDataTable();
        DataTable dtCOA = dc.usp_ChartOfAccountTreeCustom_Select(this.MyContext.CurrentCulture.ToByte(), MyContext.UserProfile.Branch_ID, COA.Banks.ToInt()).CopyToDataTable();
