<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="COAOrderAccount.aspx.cs" Inherits="Accounting_COAOrderAccount" %>
        ...
        <div class="content">
            <div class="form" style="width: 98%; margin: auto;">
                <div class="right_col">
                    ...
                    <asp:AutoComplete runat="server" ID="acAccountFrom" ServiceMethod="GetChartOfAccountsAll"
                        ValidationGroup="TransferAccount" IsException="True" IsRequired="true" LabelText="الحساب "></asp:AutoComplete>

                </div>
                <div class="left_col">
                   
                     <asp:ABFTextBox ID="txtOrderNumber" runat="server" ValidationGroup="TransferAccount" LabelText="الترتيب"
                        IsRequired="true" DataType="Int"></asp:ABFTextBox>
