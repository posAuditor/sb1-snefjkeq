...
public partial class Payments_PaymentsList : UICulturePage
{
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            int PaymentsID =  Payment_ID;


            switch (Request.PathInfo)
            {
                case "/CashIn":
                    Response.Redirect("~/Report_Dev/PrintPaymentsDev.aspx?Payments_ID=" + Payment_ID +
    ...
    private void FillPaymentsList()
    {
        ...
        {
            case "/CashIn":
                EntryType = PaymentsTypes.CashIn.ToByte();
                break;

            case "/CashInCustomer":
                EntryType = PaymentsTypes.CashInCustomer.ToByte();
                break;

            case "/CashOut":
                EntryType = PaymentsTypes.CashOut.ToByte();
                break;

            case "/CashOutVendor":
                EntryType = PaymentsTypes.CashOutVendor.ToByte();
                break;

            case "/BankDeposit":
                EntryType = PaymentsTypes.BankDeposit.ToByte();
                break;
            case "/BankDepositCustomer":
                EntryType = PaymentsTypes.BankDepositCustomer.ToByte();
                break;
            case "/BankWithdraw":
                EntryType = PaymentsTypes.BankWithDraw.ToByte();
                break;

            case "/BankWithdrawVendor":
                EntryType = PaymentsTypes.BankWithdrawVendor.ToByte();
                break;
        }

        lnkadd.NavigateUrl = PageLinks.Payments + Request.PathInfo;
