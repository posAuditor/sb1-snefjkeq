...
public partial class Payments_PaymentSimpleList : UICulturePage
{
    ...
    private void FillPaymentsList()
    {
        ...
        {
            case "/ReceiptNots":
                EntryType = PaymentsTypes.ReceiptNotes.ToByte();
                break;
            case "/CashIn":
        ...
        lnkadd.NavigateUrl = PageLinks.PaymentSimple + Request.PathInfo;
