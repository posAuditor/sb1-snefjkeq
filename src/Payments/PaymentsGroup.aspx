<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="PaymentsGroup.aspx.cs" Inherits="Payments_PaymentsGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    <div class="MainInvoiceStyleDiv">
        ...
        <div class="InvoiceSection">
            <asp:Panel ID="pnlAddDetail" runat="server" DefaultButton="btnDistibute">
                <div class="form" style="width: 90%; margin: auto;">
                    <div class="right_col">
                ...
                <br />
                <div class="btnDiv">
                    <asp:Button runat="server" ID="btnDistibute" Text="توزيع" CssClass="button" OnClick="btnAddDetail_click"
                        ValidationGroup="AddDetail" />

                    <%-- <asp:Button ID="btnAddDetail" CssClass="button" runat="server"
                        Text="<%$ Resources:Labels, Add %>"/>--%>
    ...
    <asp:Panel ID="pnlFastAddNew" CssClass="pnlPopUp" runat="server" Visible="false"
        Width="280">
        <div class="tcat">
    ...
    <asp:ModalPopupExtender ID="mpeInvoiceDistribute" runat="server" TargetControlID="HiddenField1"
        PopupControlID="pnlInvoiceDistribute" BackgroundCssClass="modal_bg" RepositionMode="RepositionOnWindowResize"
        BehaviorID="showPopUp" Y="500">
    </asp:ModalPopupExtender>

    <asp:Panel ID="pnlInvoiceDistribute" CssClass="pnlPopUp" runat="server"
        Width="480">
        <div class="tcat">
        ...
        <div class="content">
            <div class="form">
                ...
                <asp:ABFGridView runat="server" ID="gvItems" GridViewStyle="GrayStyle" DataKeyNames="ID,Invoice_ID,InvoiceTotalAmount,TotalAmount,AmountPay" AllowPaging="false">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, Serial %>">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server"
                                    NavigateUrl='<%# XPRESS.Common.PageLinks.InvoiceShortcut + "?ID=" + Eval("Invoice_ID").ToString() %>'
                                    Target="_blank">
                                 <%# Eval("Serial") %>
                                </asp:HyperLink>
                        ...
                        <asp:BoundField DataField="InvoiceTotalAmount" HeaderText="مبلغ الفاتورة" DataFormatString="{0:0.###}" />
                        <asp:BoundField DataField="TotalAmount" HeaderText="مبلغ المدفوع" DataFormatString="{0:0.###}" />
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, Collect %>">
                            <ItemTemplate>
                                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">
                                    <i class="fa fa-arrow-circle-left" style="font-size: 20px; padding-top: 10px; color: black!important"></i>
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="مبلغ الذي سيدفع">
                            <ItemTemplate>
                                <asp:ABFTextBox runat="server" ID="txtAmountPay" ValidationGroup="AmountPay" AutoPostBack="true" OnTextChanged="txtAmountPay_TextChanged"
                                    DataType="Decimal" Style="min-width: 100px;"></asp:ABFTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="<%$ Resources:Labels, Clear %>">
                            <ItemTemplate>
                                <asp:LinkButton ID="lnkClear" runat="server" OnClick="lnkClear_Click">
                                    <i class="fa fa-close" style="font-size: 20px; padding-top: 10px; color: black!important"></i>
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div class="btnDiv">
                <asp:Button ID="btnReDistribute" CssClass="button default_button" runat="server" OnClick="btnReDistribute_Click"
                    ValidationGroup="AmountPay" Text="إعادة توزيع" />
                <asp:Button ID="btnDistribute" CssClass="button default_button" runat="server" OnClick="btnDistribute_Click"
                    ValidationGroup="AmountPay" Text="<%$ Resources:Labels, OK %>" />
                <asp:Button ID="Button4" runat="server" CssClass="button" OnClick="CloseFastAddNewPopup_Click"
                    Text="<%$ Resources:Labels, Cancel %>" />
            </div>
        </div>
    </asp:Panel>
