<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="PaymentsList.aspx.cs" Inherits="Payments_PaymentsList" %>
    ...
    <asp:ABFGridView runat="server" ID="gvPaymentsList" GridViewStyle="GrayStyle" DataKeyNames="ID,Branch_ID"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="<%$ Resources:Labels, Edit %>">
                <ItemTemplate>
                    <asp:HyperLink runat="server" NavigateUrl='<%# String.Format("Payments.aspx/{1}?ID={0}", Eval("ID"),Eval("PathInfo") ) %>'
