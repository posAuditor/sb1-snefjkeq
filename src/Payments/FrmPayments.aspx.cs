...
public partial class Payments_FrmPayments : UICulturePage
{
    ...
    public int DocKindId
    {
        get
        {
            if (Request.QueryString["p"] == "CashIn")
    ...
    public byte EntryType
    {
        ...
        {
            if (Request.QueryString["p"] == "CashIn")
                return PaymentsTypes.CashIn.ToByte();
            else if (Request.QueryString["p"] == "CashInCustomer")
                return PaymentsTypes.CashInCustomer.ToByte();
            else if (Request.QueryString["p"] == "CashOut")
                return PaymentsTypes.CashOut.ToByte();
            else if (Request.QueryString["p"] == "CashOutVendor")
                return PaymentsTypes.CashOutVendor.ToByte();
            else if (Request.QueryString["p"] == "BankDeposit")
                return PaymentsTypes.BankDeposit.ToByte();
            else if (Request.QueryString["p"] == "BankWithdraw")
                return PaymentsTypes.BankWithDraw.ToByte();
            else if (Request.QueryString["p"] == "BankDepositCustomer")
                return PaymentsTypes.BankDepositCustomer.ToByte();
            else if (Request.QueryString["p"] == "BankWithdrawVendor")
                return PaymentsTypes.BankWithdrawVendor.ToByte();
            return 0;
        }
    }
    ...
    {
        if (this.DocKindId == DocumentKindClass.CashIn)
            this.PaymentOptions = MyContext.CashInOptions;
        else if (this.DocKindId == DocumentKindClass.CashInCustomer)
            this.PaymentOptions = MyContext.CashInCustomerOptions;
        else if (this.DocKindId == DocumentKindClass.CashOut)
            this.PaymentOptions = MyContext.CashOutOptions;
        else if (this.DocKindId == DocumentKindClass.CashOutVendor)
            this.PaymentOptions = MyContext.CashOutVendorOptions;
