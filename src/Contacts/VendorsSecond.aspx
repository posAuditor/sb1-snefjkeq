<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="VendorsSecond.aspx.cs" Inherits="Comp_VendorsSecond" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvTypeCar" GridViewStyle="BlueStyle" DataKeyNames="ID,Name"
        ...
        <div class="content">
            <div class="form">
                <asp:ABFTextBox ID="txtName" CssClass="field" LabelText="<%$Resources:Labels,Name %>"
                 ...
                 <asp:ABFTextBox ID="txtVatNumber" CssClass="field" LabelText="الرقم الضريبي"
                    runat="server" IsRequired="true" ValidationGroup="AddNew"></asp:ABFTextBox>

                 <asp:ABFTextBox ID="txtVatNote" CssClass="field" LabelText=" ملاحظات"
