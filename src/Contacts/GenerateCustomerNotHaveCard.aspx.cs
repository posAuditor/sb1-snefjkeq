...
public partial class Contacts_GenerateCustomerNotHaveCard : UICulturePage
{
    ...
    private void FillCustomersList()
    {
        ...
        this.dtCustomersList = dc.GetCustomerNotHaveCard().CopyToDataTable();
    ...
    protected void lnk_Click(object sender, EventArgs e)
    {
        ...
        var Contact_ID = dc.usp_ContactWithTax_Insert(coa.Branch_ID, coa.Currency_ID, DocSerials.Customer.ToInt(), coa.Name, 'C',"", "", "",
            null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);

        dc.usp_Customers_Insert(Contact_ID, ChartofAccount_ID, null, null, null, null);
