<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="AssetsSelling.aspx.cs" Inherits="FixedAssets_AssetsSelling" %>
        ...
        <div class="InvoiceSection">
            <div class="form" style="width: 90%; margin: auto;">
                <div class="right_col">
                    ...
                    <asp:ABFTextBox ID="txtEndUseDate" runat="server" ValidationGroup="Save" LabelText="<%$Resources:Labels,EndUseDate %>"
                ...
                <div class="left_col">
                    ...
                    <asp:ABFTextBox ID="txtSellDate" runat="server" ValidationGroup="Save" LabelText="<%$Resources:Labels,SellDate %>"
