<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="AssetsSellingList.aspx.cs" Inherits="FixedAssets_AssetsSellingList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvAssetSellingsList" GridViewStyle="GrayStyle" DataKeyNames="ID"
        OnPageIndexChanging="gvAssetSellingsList_PageIndexChanging">
        <Columns>
            ...
            <asp:BoundField DataField="Serial" HeaderText="رقم البيع" />   
            ...
            <asp:BoundField DataField="SellDate" HeaderText="<%$Resources:Labels,SellDate %>"
            ...
            <asp:TemplateField HeaderText="<%$ Resources:Labels, Edit %>">
                <ItemTemplate>
                    <asp:HyperLink runat="server" NavigateUrl='<%# String.Format("AssetsSelling.aspx?ID={0}", Eval("ID")) %>'
