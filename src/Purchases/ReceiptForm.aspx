<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="ReceiptForm.aspx.cs" Inherits="Purchases_ReceiptForm" %>
                                            ...
                                            <tr class="grdWoutHeader_row">
                                                ...
                                                <td class="colW">
                                                    <asp:ABFTextBox ID="txtItemPercentageDiscount" runat="server" LabelText="<%$Resources:Labels,PercentageDiscount %>" AutoPostBack="true" OnTextChanged="txtItemPercentageDiscount_TextChanged" TabIndex="5 "
                                                        MinValue="0" DataType="Decimal" ValidationGroup="AddItem" VisibleText="false" CssClass="barcode cls" onkeyup="return focusOnNext(event, 'cph_txtAmount')" Style="background-color: transparent; border-radius: 0px!important">
                                                    </asp:ABFTextBox>
                                                </td>
                                                <td class="colW">
                            ...
                            <td colspan="12">
                                <asp:AuditorGridView runat="server" ID="gvItems" GridViewStyle="GrayStyle" DataKeyNames="ID,Item_ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField  ItemStyle-CssClass="colW" DataField="UnitCostEvaluate" HeaderText="<%$Resources:Labels,Cost %>" DataFormatString="{0:0.####}" />
