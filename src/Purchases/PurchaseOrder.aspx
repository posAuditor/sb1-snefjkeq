<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="PurchaseOrder.aspx.cs" Inherits="Purchases_PurchaseOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    <div class="MainInvoiceStyleDiv">
        ...
        <div class="InvoiceHeader">
            ...
            <asp:Label runat="server" visible="false" Style="padding-left: 10px; padding-right: 10px; font-weight: bold;"><%=Resources.Labels.PurchaseOrder %></asp:Label>
            ...
            <div runat="server" visible="false" id="divPurchaseOrderNo" style="display: inline-block;">
             ...
             <asp:Nav runat="server"  ID="ucNav"  /><asp:Favorit runat="server" ID="Favorit1" />
        </div>
                            ...
                            <td style="width: 11%">
                                                ...
                                                <table>
                                                        <tr>
                                                         ...
                                                         MinValue="0" DataType="Decimal" IsRequired="true" ValidationGroup="AddItem"></asp:ABFTextBox></td>
                ...
                <asp:Panel ID="pnlAddItem" runat="server" DefaultButton="btnAddItem">
                    <div class="form" style="width: 90%; margin: auto;">
                        ...
                        <div class="left_col">
                            ...
                            <asp:ABFTextBox CssClass="hiddencol" ID="txtExpirationDate" runat="server"
                                Enabled="false" IsHideable="true"></asp:ABFTextBox>
