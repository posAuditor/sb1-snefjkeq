<%@ Page Title="" Language="C#" 
    AutoEventWireup="true" CodeFile="FrmReceiptEntry.aspx.cs" Inherits="Purchases_ReceiptEntryUI_FrmReceiptEntry" %>
...
<head runat="server">    
    ...
    <script type="text/javascript">
        ...
        function findItem() {
            ...
            $("#searchDiv").load("../Purchases/ReceiptEntryUI/FrmReceiptEntrySelect.aspx?requestCode=1");
        ...
        function documentSelected(requestCode, selectedDocumentId) {
            if (requestCode == 1) {
                ...
                $.getJSON("../../api/ReceiptEntry/FindDocumentById", { InvoiceID: selectedDocumentId },
                    function (response) {
                        if (response.length == 1) {
                            ...
                            $.getJSON("../../api/ReceiptEntry/GetDocumentItems", { InvoiceID: selectedDocumentId },
        ...
        function saveItem(isApproving) {
            ...
            if (/*paymentMethod == -1 &&*/ $("#acVendor").dxSelectBox('instance').option('value') == null) {
                ...
                var id = $("#Id").val();
                $.post("../../api/ReceiptEntry/SaveReceiptEntry", {
        ...
        function printItem() {
            if ($("#Id").val() != null && $("#Id").val() != '' && $("#Id").val().length > 0) {
                ...
                $("#searchDiv").load("../Purchases/ReceiptEntryUI/FrmReceiptEntrySelect.aspx?requestCode=2");
                showModal('#searchModal');
            }
        }
        ...
        function CancelReceiptEntryApprovel(SourceDocumentId) {

            $.post("../../api/ReceiptEntry/CancelReceiptEntryApprovel", { ID: SourceDocumentId },
                function (response) {
...
<body runat="server">
    <form id="form1" runat="server">    <div class="MainInvoiceStyleDiv">
        <input type="hidden" id="Operation" />
        <input type="hidden" id="Id" />
        <input type="hidden" id="COAVendors" value="<%=XPRESS.Common.COA.Vendors.ToString()%>" />
        <input type="hidden" id="EntryType" value="2" />
