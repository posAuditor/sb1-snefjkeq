<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmPurchaseReturnInvoiceSelect.aspx.cs" Inherits="Purchases_PurchaseReturnUI_FrmPurchaseReturnInvoiceSelect" %>
        ...
        function refreshData() {
            ...
            var customDataSource = new DevExpress.data.CustomStore({
                ...
                load: function (loadOptions) {
                    ...
                    $.post('../../api/PurchaseReturn/Search', {
                        ...
                        'UserRefNo': userRefNo, 'BillNo': billNo, 'requestCode': requestCode,
            ...
            $("#searchDgvDiv").dxDataGrid({
                ...
                columns:
                    [
                        ...
                        {
                            dataField: "GrossTotalAmount",
                            caption: '<%=Resources.Labels.GrossTotal%>',
                            allowEditing: false,
                            dataType: "string",
                            alignment: "center",
                            format: "decimal",
                        },
                        {
                            ...
                            caption: '<%=Resources.Labels.Customer%>',
                            allowEditing: false,
                            dataType: "string",
                            alignment: "center",
                        },
                        ...
                        },
                        {
                            ...
                            buttons: [{
                                ...
                                onClick(e) {
                                    console.log(e);
                                    CancelReturnReceiptApprovel(e.row.data.ID);
                                    $(e.event.currentTarget).hide();
                                    e.column.buttons[2].visible = false;
