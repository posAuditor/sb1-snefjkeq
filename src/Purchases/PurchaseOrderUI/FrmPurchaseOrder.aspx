<%@ Page Title="" Language="C#" 
    AutoEventWireup="true" CodeFile="FrmPurchaseOrder.aspx.cs" Inherits="Purchases_PurchaseOrderUI_FrmPurchaseOrder" %>
...
<head runat="server">    
    ...
    <script type="text/javascript">
                                        ...
                                        $.getJSON("../../api/Item/FindByBarcode", { contextKey: ",,,true,1", Source: e.value },
                                            function (response) {
                                                if (response != null) {
                                                    ...
                                                    if (<%=MyContext.SalesOrderOptions.SetAmountToOne.ToString().ToLower()%>== true)
        ...
        function findItem() {
            $("#searchDiv").load("../../Purchases/PurchaseOrderUI/FrmPurchaseOrderSelect.aspx?requestCode=1");
        ...
        function documentSelected(requestCode, selectedDocumentId) {
            if (requestCode == 1) {
                ...
                $.getJSON("../../api/PurchaseOrder/FindDocumentById", { InvoiceID: selectedDocumentId },
                    function (response) {
                        if (response.length == 1) {
                            ...
                            $.getJSON("../../api/PurchaseOrder/GetDocumentItems", { InvoiceID: selectedDocumentId },
        ...
        function printItem() {
            if ($("#Id").val() != null && $("#Id").val() != '' && $("#Id").val().length > 0) {
                ...
                $("#searchDiv").load("../../Purchases/PurchaseOrderUI/FrmPurchaseOrderSelect.aspx?requestCode=2");
                showModal('#searchModal');
            }
        }
        ...
        function CancelPurchaseOrderApprovel(SourceDocumentId) {

            $.post("../../api/PurchaseOrder/CancelPurchaseOrderApprovel", { ID: SourceDocumentId },
                function (response) {
...
<body runat="server">
    ...
    <div class="MainInvoiceStyleDiv">
        ...
        <input type="hidden" id="EntryType" value="0" />
