<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ReceiptsListEntry.aspx.cs" Inherits="Purchases_ReceiptsListEntry" %>
            ...
            <asp:TemplateField HeaderText="<%$ Resources:Labels, Receipt %>">
                <ItemTemplate>
                    <asp:HyperLink runat="server" NavigateUrl='<%# String.Format("{0}", Eval("ToReceiptPage")) %>'
                        Text="<%$ Resources:Labels, Receipt %>" Visible="false" />
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField  HeaderText ="<%$ Resources:Labels, ReturnRecipt %>" Visible="false">
                <ItemTemplate>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# String.Format("ReturnReceipt.aspx?FromReceiptID={0}", Eval("ID")) %>'
                        Text="<%$ Resources:Labels, ReturnRecipt %>" Visible="false" />
                </ItemTemplate>
            </asp:TemplateField>
