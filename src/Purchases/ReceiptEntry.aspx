<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master" AutoEventWireup="true" CodeFile="ReceiptEntry.aspx.cs" Inherits="Purchases_ReceiptEntry" %>
            ...
            <div class="container">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="width: 7%">
                                ...
                                <asp:ABFTextBox ID="txtQty" runat="server"
                            ...
                            <td style="width: 12%">
                                ...
                                <br />
                                <asp:ABFTextBox ID="txtCost" runat="server"
                                    MinValue="0.00000001" DataType="Decimal" IsRequired="true" ValidationGroup="AddItem"></asp:ABFTextBox>
                            </td>
                            <td>


                                <div class="btnDiv" style="padding-top: 24px;">
                                    <asp:LinkButton ID="LinkButton1" OnClick="btnAddItem_click" ValidationGroup="AddItem" runat="server"><i class="btnShartcatInvoice demo-icon icon-plus" style=" font-size: 20px; padding-top: 10px;"></i></asp:LinkButton>
                ...
                <asp:ABFGridView runat="server" ID="gvItems" GridViewStyle="GrayStyle" DataKeyNames="ID"
                    ...
                    <asp:BoundField DataField="ExpirationDate" HeaderText="<%$Resources:Labels,ExpirationDate %>" ItemStyle-CssClass="BatchCol"
                        DataFormatString="{0:d/M/yyyy}" />--%>
                        <asp:BoundField DataField="UnitCost" HeaderText="<%$Resources:Labels,Cost %>"  />
