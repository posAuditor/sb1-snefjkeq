<%@ Page Title="" Language="C#" 
    AutoEventWireup="true" CodeFile="FrmPurchaseInvoice.aspx.cs" Inherits="Purchases_PurchaseUI_FrmPurchaseInvoice" %>
...
<head runat="server">    
    <script type="text/javascript">
        ...
        function loadDivs() {
            if (<%=MyContext.PurchasesOptions.UseStoreByRecord.ToString().ToLower()%>== true) {
                $("#acStoreDiv").hide();
            }

            if (<%=MyContext.PurchasesOptions.UseRefNo.ToString().ToLower()%>== true) {
                $("#refNoDiv").show();
            }
            else $("#refNoDiv").hide();

            if (<%=MyContext.PurchasesOptions.UseCostCenter.ToString().ToLower()%>== true) {
                $("#costCenterDiv").show();
            }
        ...
        $(document).ready(function () {
            ...
            if (<%=MyContext.PurchasesOptions.DiscountPerRow.ToString().ToLower()%>== true) {
        ...
        function initializeAll(allItems) {
                ...
                $("#cmbxBranch").dxSelectBox({
                    ...
                    onValueChanged: function (data) {
                        $.getJSON("../../api/Structure/GetStorPermissionsGroup", { 'contextKey': $("#cmbxBranch").dxSelectBox('instance').option('value') + "," + '<%=this.MyContext.UserProfile.UserId%>' }, function (storesResponse) {
                            ...
                            if (<%=MyContext.PurchasesOptions.KeepStore.ToString().ToLower()%>== true &&
                                    <%=MyContext.PurchasesOptions.UseStoreByRecord.ToString().ToLower()%>== false && storesResponse.length > 0)
                            ...
                            $("#acStore").dxSelectBox({
                                ...
                                visible: '<%=!MyContext.PurchasesOptions.UseStoreByRecord%>',
                                onValueChanged: function (data) {
                        ...
                        $.getJSON("../../api/CostCenter/GetCostCenters", { 'contextKey': '<%=this.GetCostCenterContextKey()%>' + $("#cmbxBranch").dxSelectBox('instance').option('value') }, function (costCentersResponse) {
                            ...
                            if (<%=MyContext.PurchasesOptions.KeepCostCenter.ToString().ToLower()%>== true && costCentersResponse.length > 0)
                            ...
                            $("#cmbxCostCenter").dxSelectBox({
                                ...
                                visible: '<%=!MyContext.PurchasesOptions.UseCostCenterByRecord%>',
                                onValueChanged: function (data) {
                        ...
                        $.getJSON("../../api/General/GetContact", { 'contextKey': "V," + $("#cmbxBranch").dxSelectBox('instance').option('value') + "," + <%=ddlCurrency.SelectedValue%> + "," }, function (vendorsResponse) {
                            ...
                            if (<%=MyContext.PurchasesOptions.KeepDefaultSupplier.ToString().ToLower()%>== true && vendorsResponse.length > 0)
                    ...
                    $("#purchaseGridContainer").dxDataGrid({
                        columnFixing: {
                            enabled: true
                        },
                        ...
                        columns:
                            [
                                ...
                                },
                                {
                                    ...
                                    lookup: {
                                        dataSource: function getUnits(options) {
                                            var rows = $("#purchaseGridContainer").dxDataGrid("instance").getVisibleRows();
                                ...
                                },
                                {
                                    ...
                                    alignment: "center",
                                    width: 80,
                                    visible: <%=this.MyContext.PurchasesOptions.UseBounus.ToString().ToLower()%>,
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    alignment: "center",
                                    width: 120,
                                    visible: <%=this.MyContext.PurchasesOptions.UseStoreByRecord.ToString().ToLower()%>,
                                },
                                ...
                                },
                                {
                                    ...
                                    alignment: "center",
                                    width: 80,
                                    visible: <%=this.MyContext.PurchasesOptions.UseBatchByRecord.ToString().ToLower()%>,
                                },
                                {
                                    ...
                                    alignment: "center",
                                    width: 80,
                                    visible: <%=this.MyContext.PurchasesOptions.UseTruckByRecord.ToString().ToLower()%>,
                                },
                                {
                                    ...
                                    alignment: "center",
                                    width: 80,
                                    visible: <%=this.MyContext.PurchasesOptions.UseShelf.ToString().ToLower()%>,
                                },
                                {
                                    ...
                                    alignment: "center",
                                    width: 120,
                                    visible: <%=this.MyContext.PurchasesOptions.UseCostCenterByRecord.ToString().ToLower()%>,
                                },
                                {
                                    dataField: "NotesCol",
                                    ...
                                    alignment: "center",
                                    width: 250,
                                    visible: <%=this.MyContext.PurchasesOptions.UseNote.ToString().ToLower()%>,
                                },
                                {
                                    dataField: "ItemIdCol",
                                ...
                                },
                                {
                                    ...
                                    buttons: [{
                                        ...
                                        onClick: function (e) {
                                            console.log(e);
                                            $('#purchaseGridContainer').dxDataGrid('instance').deleteRow(e.row.rowIndex);
                                            var grid = $("#purchaseGridContainer").dxDataGrid("instance");
                                            grid.saveEditData();
                                        }
                                    }]
                                }
                                        ...
                                        $.getJSON("../../api/Item/FindByBarcode", { contextKey: ",,,true,1", Source: e.value },
                                            function (response) {
                                                if (response != null) {
                                                    ...
                                                    if (<%=MyContext.PurchasesOptions.SetAmountToOne.ToString().ToLower()%>== true)
                                                        component.cellValue(rowIndex, "AmountCol", 1);
                                                    component.cellValue(rowIndex, "UnitCostEvaluateCol", response[0].Cost);
                                                    ...
                                                    if (response[0].IsUseTax != null && response[0].IsUseTax == true) {
                                                        ...
                                                        if (response[0].IsTaxIncludedInPurchase != null && response[0].IsTaxIncludedInPurchase == true) {
                                    ...
                                    if (e.value != null && e.value != '') {
                                        if (component.cellValue(rowIndex, "IsUseTaxCol") == true) {
                                            $.getJSON("../../api/Tax/FindItem", { Id: e.value },
                                                function (response) {
                                                    if (response != null) {
                                                        if (component.cellValue(rowIndex, "IsTaxIncludedInPurchaseCol") == true) {
                        ...
                        onKeyDown: function (e) {
                            ...
                            if (key == "Enter" || keyCode == 13) {// Enter
                                ...
                                var columns = $("#purchaseGridContainer").dxDataGrid("instance").getVisibleColumns();
                            ...
                            //else console.log('keycode:' + keyCode);
                        },
                        summary: {
                            totalItems: [
                                /////////////////////////////
            ...
            /*******************************************/
            $.getJSON("../../api/PrintTemplate/GetDefaultTemplateByKindId", { KindId: '<%=DocumentKindClass.PurchaseInvoice%>', 'EntryType': null },
                function (response) {
                    if (response.length > 0) {
                        $("#cmbxTemplate").dxSelectBox({
                            dataSource: DevExpress.data.AspNet.createStore({
                                ...
                                loadMethod: "get",
                                loadParams: { 'KindId': '<%=DocumentKindClass.PurchaseInvoice%>', 'EntryType': null },
                                displayExpr: "Name",
                                valueExpr: "Id"
                            }),
                            displayExpr: "Name",
        ...
        function continueDone() {
            ...
            setEnabled("#txtOperationDate", true);
                ...
                $.getJSON('../../api/GridOrdering/FindGridOrdering', { 'GridId': '<%=DocumentKindClass.PurchaseInvoice%>', 'UserId': '<%=MyContext.UserProfile.Contact_ID%>' }, function (response) {
        ...
        function ValidateRows(skipEmptyRows, toSave) {
            var UseStoreByRecord = <%=MyContext.PurchasesOptions.UseStoreByRecord.ToString().ToLower()%>;
            var grid = $("#purchaseGridContainer").dxDataGrid("instance");
            ...
            for (i = 0; i < rows.length; i++) {
                ...
                if (skipEmptyRows == false || isEmptyRow == false) {
                    ...
                    <%=MyContext.PurchasesOptions.AllowZeroInPurchase.ToString().ToLower()%>!= true) {
                        hasError = true;
                    ...
                    else if ( <%=MyContext.PurchasesOptions.UseStoreByRecord.ToString().ToLower()%> == true &&
                        (rows[i].StoreIdCol == null || rows[i].StoreIdCol == '')) {
                        hasError = true;
                        errorMessage = "<%=Resources.Messages.MsgDocStoreRequired%>";
                        cellName = "StoreIdCol";
        ...
        function clearTools() {
           ...
           if (<%=MyContext.PurchasesOptions.KeepDefaultSupplier.ToString().ToLower()%>!= true)
                $("#acVendor").dxSelectBox('instance').option({ value: null });

            if (<%=MyContext.PurchasesOptions.KeepStore.ToString().ToLower()%>!= true)
                $("#acStore").dxSelectBox('instance').option({ value: null });

            if (<%=MyContext.PurchasesOptions.KeepCostCenter.ToString().ToLower()%>!= true)
                $("#cmbxCostCenter").dxSelectBox('instance').option({ value: null });

            if (<%=MyContext.PurchasesOptions.KeepDocDate.ToString().ToLower()%>!= true) {
        ...
        function findItem() {
            $("#searchDiv").load("../Purchases/PurchaseUI/FrmPurchaseInvoiceSelect.aspx?requestCode=1");
        ...
        function documentSelected(requestCode, selectedDocumentId) {
            if (requestCode == 1) {
                            ...
                            //$('#' + '<%=this.ddlPaymentMethod.ClientID.ToString() %>').val(response[0].typePayment_ID);
                              ...
                              $.getJSON("../../api/Purchase/GetDocumentItems", { InvoiceID: selectedDocumentId },
                                  function (responseTable) {
                                      if (<%=MyContext.PurchasesOptions.UseStoreByRecord.ToString().ToLower()%>== false) {
                ...
                if (printTemplateId != null && printTemplateId != '') {
                    window.open('../../PrintTemplate/PrintDocumentHtml.aspx?PrintTemplateId=' + printTemplateId + '&InvoiceID=' + selectedDocumentId + "&DocKindId=" + '<%=DocumentKindClass.PurchaseInvoice%>', "PopupWindow", "width=" + screen.availWidth + ",height=" + screen.availHeight);
                }
                else {
        ...
        function showOperationDetials(SourceDocumentId) {
            $("#operationDetailsDiv").load("../../OperationDetails/FrmOperationDetials.aspx?SourceDocId=" + SourceDocumentId + "&SourceTableId=" +<%=DocumentKindClass.PurchaseInvoice%>);
            showModal('#operationDetailsModal');
        }

        function showPurchaseExpense(SourceDocumentId) {
            var link = "../../Purchases/PurchaseUI/FrmPurchaseExpense.aspx?PurchaseId=" + SourceDocumentId;
            parent.setForm(link);
        }
        ...
        function calcDocTotals() {
            if (<%=MyContext.PurchasesOptions.DiscountPerRow.ToString().ToLower()%>== false) {
        ...
        function saveItem(isApproving) {
            ...
            if (/*paymentMethod == -1 && */$("#acVendor").dxSelectBox('instance').option('value') == null) {
            ...
            else if (<%=MyContext.PurchasesOptions.UseStoreByRecord.ToString().ToLower()%>== false && $("#acStore").dxSelectBox('instance').option('value') == null) {
                showErrorMessage("<%=Resources.Messages.MsgDocStoreRequired%>", "#txtOperationDate");
                return false;
            }
            else if (<%=MyContext.PurchasesOptions.UseCostCenter.ToString().ToLower()%>== true &&
                <%=MyContext.PurchasesOptions.ForceCostCenter.ToString().ToLower()%>== true &&
                $("#cmbxCostCenter").dxSelectBox('instance').option('value') == null) {
                showErrorMessage("<%=Resources.Messages.MsgDocCostCenterRequired%>", "#cmbxCostCenter");
                return false;
            }
            else if (<%=MyContext.PurchasesOptions.UseRefNo.ToString().ToLower()%>== true &&
                <%=MyContext.PurchasesOptions.ForceRefNo.ToString().ToLower()%>== true &&
                ...
                for (i = 0; i < rows.length; i++) {
                    ...
                    if (<%=MyContext.PurchasesOptions.UseCostCenterByRecord.ToString().ToLower()%>== false)
                        rowCostCenterIdCol = rows[i].CostCenterIdCol;

                    if (<%=MyContext.PurchasesOptions.UseBatchByRecord.ToString().ToLower()%>== false)
                        batchIdCol = rows[i].BatchIdCol;

                    if (<%=MyContext.PurchasesOptions.UseTruckByRecord.ToString().ToLower()%>== false)
                        truckIdCol = rows[i].TruckIdCol;

                    if (<%=MyContext.PurchasesOptions.UseShelf.ToString().ToLower()%>== false)
                        shelfIdCol = rows[i].ShelfIdCol;

                    if (<%=MyContext.PurchasesOptions.UseNote.ToString().ToLower()%>== false)
                ...
                var id = $("#Id").val();
                $.post("../../api/Purchase/SavePurchaseInvoice", {
                    'Id': id, 'BranchId': branchId, 'StoreId': storeId, 'PaymentMethod': paymentMethod, 'CostCenterId': costCenterId, 'UserRefNo': userRefNo,
                    'VendorId': vendorId, 'AcPaymentAddress': acPaymentAddress, 'CurrencyId': currencyId, 'AcTelephone': acTelephone, 'AcCashAccount': acCashAccount,
                    'OperationDate': docDate, 'Ratio': ratio, 'TotalCashDiscountSum': totalCashDiscountSum, 'TotalTaxSum': totalTaxSum, 'Total': totalBeforTaxSum, 'GrossTotal': totalCostEvaluateSum,
                    'EditMode': editMode, 'UserProfileContact_ID': '<%=MyContext.UserProfile.Contact_ID%>', 'CashierAccount_ID': '<%=MyContext.UserProfile.CashierAccount_ID%>',
                'IsApproving': isApproving,/*'IsPercentDiscount':isPercentDiscount,*/'PercentageDiscount': invPercentageDiscount, 'Source': dataRows
            },
                function (response) {
                    if (response.Code > 0) {
                        clearTools();
                        ...
                        $("#btnConfirmPrint").click(function () {
                            hideModal('#printModal');
                            var printTemplateId = $("#cmbxTemplate").dxSelectBox('instance').option('value');
                            window.open('../../PrintTemplate/PrintDocumentHtml.aspx?PrintTemplateId=' + printTemplateId + '&InvoiceID=' + response.Code + "&DocKindId=" + '<%=DocumentKindClass.PurchaseInvoice%>', "PopupWindow", "width=" + screen.availWidth + ",height=" + screen.availHeight);

                            if (<%=MyContext.PurchasesOptions.AddNewAfterSave.ToString().ToLower()%>== true)
                                addItem();
                        });

                        //------------------------ btnSendEmail ---------------------------//
                        $("#btnSendEmail").click(function () {
                            $.post('../../api/General/GetContactDetialData', { "DocumentId": response.Code, "KindId": '<%=DocumentKindClass.PurchaseInvoice%>' }, function (queryResponse) {
                                if (queryResponse != "" && queryResponse.length != 0 && validateEmail(queryResponse) == true) {
                                    $.post('../../api/General/SendEmail', { "DocumentId": response.Code, "KindId": '<%=DocumentKindClass.PurchaseInvoice%>', "SendType": 1 }, function (sendResponse) {
                                        ...
                                        $("#btnConfirmEmail").click(function () {
                                            ...
                                            if ($('#txtEmailTo').val() == "") {
                                                ...
                                                $.post('../../api/General/SendEmail', { "DocumentId": response.Code, "KindId": '<%=DocumentKindClass.PurchaseInvoice%>', "SendType": 2, "Data": $('#txtEmailTo').val() }, function (sendResponse) {
                                                    if (sendResponse.Code == 100)
                                                        hideModal('#printModal');
                                                    else {
                                                        $("#sendview").html(sendResponse.Message);
                        ...
                        $("#btnSendSms").click(function () {
                            $.post('../../api/General/GetContactDetialData', { "DocumentId": response.Code, "KindId": '<%=DocumentKindClass.PurchaseInvoice%>' }, function (queryResponse) {
                                if (queryResponse != "" && queryResponse.length != 0 && validateMobile(queryResponse) == true) {
                                    $.post('../../api/General/SendSms', { "DocumentId": response.Code, "KindId": '<%=DocumentKindClass.PurchaseInvoice%>', "SendType": 1 }, function (sendResponse) {
                                            if (sendResponse.Code == 100)
                                                hideModal('#printModal');
                                            else {
                                                $("#sendview").html(sendResponse.Message);
                                        ...
                                        $("#btnConfirmMobile").click(function () {
                                            ...
                                            if ($('#txtMobileTo').val() == "") {
                                                ...
                                                $.post('../../api/General/SendSms', { "DocumentId": response.Code, "KindId": '<%=DocumentKindClass.PurchaseInvoice%>', "SendType": 2, "Data": $('#txtMobileTo').val() }, function (sendResponse) {
                                                    if (sendResponse.Code == 100)
                                                        hideModal('#printModal');
                                                    else {
                                                        $("#sendview").html(sendResponse.Message);
        ...
        function printItem() {
            if ($("#Id").val() != null && $("#Id").val() != '' && $("#Id").val().length > 0) {
                ...
                $("#searchDiv").load("../Purchases/PurchaseUI/FrmPurchaseInvoiceSelect.aspx?requestCode=2");
                showModal('#searchModal');
            }
        }
        ...
        function saveGridOrdering() {
            ...
            $.post("../../api/GridOrdering/SaveGridOrdering", {
                'GridId': '<%=DocumentKindClass.PurchaseInvoice%>',
        ...
        function CancelReceiptApprovel(SourceDocumentId) {
            $.post("../../api/Purchase/CancelReceiptApprovel", { ID: SourceDocumentId },
                function (response) {
...
<body runat="server">
    ...
    <div class="MainInvoiceStyleDiv">
        ...
        <input type="hidden" id="SourceTypeId" value="<%=DocumentKindClass.PurchaseInvoice %>" />
        ...
        <div class="modal fade" id="searchModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><%=Resources.Labels.SelectPurchase %></h5>
                        <button type="button" class="close" data-bs-dismiss="modal">x</button>
                    </div>
        ...
        <div class="modal fade" id="purchaseExpensesModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="purchaseExpensesModalLabel"><%=Resources.Labels.OperationDetails %></h5>
                        <button type="button" class="close" data-bs-dismiss="modal">x</button>
                    </div>
                    <div class="modal-body" style="max-height: 500px; overflow: auto;">
                        <div id="purchaseExpensesDiv">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-lg btn-danger" data-bs-dismiss="modal"><%=Resources.Labels.Close%></button>
            ...
            <div class="dx-viewport">
                ...
                <div class="row">
                    <div class="dxGridParent">
                        <div id="purchaseGridContainer" class="dxGrid col-md-12" <%--style="zoom:125%"--%>></div>
                    </div>
                </div>
