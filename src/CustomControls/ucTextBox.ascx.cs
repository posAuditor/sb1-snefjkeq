...
public class txtBoxEventArgs : EventArgs
{
    ...
    public txtBoxEventArgs(string Text, string Value)
    {
        this.Value = Value;
        this.Text = Text;
    }
...
public partial class CustomControls_ucTextBox : System.Web.UI.UserControl
{
    ...
    public delegate void EventHandler(object sender, txtBoxEventArgs e);
    ...
    public string Text
    {
        ...
        set { txtAutoCompleteText.Text = value; }
    }
