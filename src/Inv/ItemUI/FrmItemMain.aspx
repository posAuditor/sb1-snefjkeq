<%@ Page Title="" Language="C#" 
    AutoEventWireup="true" CodeFile="FrmItemMain.aspx.cs" Inherits="Inv_ItemUI_FrmItemMain" %>
...
<head runat="server">    
    <script type="text/javascript">
        ...
        function ValidateProductRows(skipEmptyRows, toSave) {
            return true;
        ...
        function AddPricesRowBottom(focusRow) {
            if (ValidateProductRows(false, false) == true) {
        ...
        var $ = jQuery.noConflict();
        function loadItems(refreshDataGrid) {
        ...
        $(document).ready(function () {
            ...
            $.getJSON("../../api/ItemCategory/GetItemsCategories", null, function (exResponse) {
                let allMyItems = [];
                for (i = 0; i < exResponse.length; i++) {
                    allMyItems.push(exResponse[i]);
                }

                $("#acCategorySearch").dxSelectBox({
                    ...
                    value: null,
                    searchEnabled: true,
                    placeholder: '<%=Resources.Labels.SelectProductCategory%>',
            ...
            $("#acItem").dxSelectBox({
                ...
                value: null,
                searchEnabled: true,
                placeholder: '<%=Resources.Labels.Item%>',
                rtlEnabled:<%=(this.MyContext.CurrentCulture==XPRESS.Common.ABCulture.Arabic).ToString().ToLower()%>,
            }).dxSelectBox("instance");
            /*******************************************/
            ...
            $("#acTaxItemeCard").dxSelectBox({
                ...
                onValueChanged: function (data) {
                    $("#chkIsUseTax").prop("checked", true);

                },
                rtlEnabled:<%=(this.MyContext.CurrentCulture==XPRESS.Common.ABCulture.Arabic).ToString().ToLower()%>,
            }).dxSelectBox("instance");
            /******************************************/
            $("#acTaxForAll").dxSelectBox({
                dataSource: DevExpress.data.AspNet.createStore({
                    key: "ID",
                    loadUrl: "../../api/Tax/GetTaxes",
                    loadMethod: "get",
            ...
            $("#btnDelete").click(function () {
                ...
                $.post("../../api/Item/DeleteItem", { Id: id }, function (response) {
                    if (response.Code == 100) {
                        ...
                        refreshProductList();
                        clearProductTools();
                        $("#deleteviewerror").html('<%=Resources.Messages.MsgDeleteSuccess%>');
                        $("#deleteerrordiv").addClass("alert-success");
                        $("#deleteerrordiv").removeClass("alert-danger");
                        $("#deleteerrordiv").fadeIn();
                        $("#deleteerrordiv").fadeOut('slow', function () {
                            hideModal("#deleteItemModal");
                            $("#deleteerrordiv").fadeOut();
                        });
                    }
                    else if (response.Code == -101) {
                        $("#deleteviewerror").html(response.Message);
                        $("#deleteerrordiv").removeClass("alert-success");
                        $("#deleteerrordiv").addClass("alert-danger");
                        $("#deleteerrordiv").fadeIn();
                    }
                });
            });
            ...
            /*****************************************/
            $("#btnSetTax").click(function () {
                if ($("#acTaxForAll").dxSelectBox('instance').option('value') == null) {
                    $("#taxerrordiv").fadeIn();
                    $("#taxviewerror").html("<%=Resources.Messages.MsgTaxRequired%>");
                    $("#taxerrordiv").fadeOut('slow');
                    $('#acTaxForAll').focus();
                    return false;
                }
                else {
                    var taxId = $("#acTaxForAll").dxSelectBox('instance').option('value');
                    $.post('../../api/Item/UpdateTax', { TaxId: taxId },
                        function (response) {
                            if (response.Code != 100) {
                                $("#taxerrordiv").addClass("alert-danger");
                                $("#taxerrordiv").removeClass("alert-success");
                                $("#taxerrordiv").fadeIn();
                                $("#taxviewerror").html(response.Message);
                                $("#taxerrordiv").fadeOut('slow');
                            }
                            else {
                                $("#taxerrordiv").removeClass("alert-danger");
                                $("#taxerrordiv").addClass("alert-success");
                                $("#taxerrordiv").fadeIn();
                                $("#taxviewerror").html(response.Message);
                                $("#taxerrordiv").fadeOut('slow', function () { hideModal("#setTaxModal"); });
                            }
                        }
                    );
                }
        ...
        function refreshProductList() {
            ...
            if ($("#acCategorySearch").dxSelectBox('instance').option('value') != null && $("#acCategorySearch").dxSelectBox('instance').option('value') != '')
                category = $("#acCategorySearch").dxSelectBox('instance').option('value');

            if ($(<%=ddlItemTypeSearch.ClientID%>).val() != null)
                ddlItemType = $(<%=ddlItemTypeSearch.ClientID%>).val();
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            buttons: [{
                                ...
                                onClick(e) {
                                    deleteProduct(e.row.data.ID, e.row.data.Name + "\n" + e.row.data.NameEN);
                                }
                            }]
                        }
                    ],
        ...
        function clearProductTools() {
           ...
           // $(<%=ddlItemTypeItemeCard.ClientID%>).val(null);
            ...
            $("#chkIsUseTax").prop("checked", <%=this.GetEnableEInvoice().ToString().ToLower()%>);
        ...
        function addProduct() {
            ...
            $.getJSON('../../api/Item/GenerateCodeItem', null, function (response) {
                $('#txtCodeItem').val(response);
        ...
        function editProduct(id) {
            ...
            $.getJSON('../../api/Item/FindById', { Id: id },
                function (response) {
                    ...
                    $(<%=ddlItemTypeItemeCard.ClientID%>).val(response[0].Type);
        ...
        function saveProduct() {
            ...
            if ($('#txtCost').val() == "" || $('#txtCost').val() == null) {
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemCostRequired%>");
                ...
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemPriceRequired%>");
                $("#errordiv").fadeOut('slow');
                $('#txtPriceUnite').focus();
                return false;
            }
            else if ($('#txtWholesalePrice').val() == "" || $('#txtWholesalePrice').val() == null) {
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemPriceRequired%>");
                $("#errordiv").fadeOut('slow');
            ...
            else if ($('#txtSpecialPrice').val() == "" || $('#txtSpecialPrice').val() == null) {
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemPriceRequired%>");
                $("#errordiv").fadeOut('slow');
                ...
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemNameRequred%>");
                $("#errordiv").fadeOut('slow');
                $('#txtNameAr').focus();
                return false;
            }
            <%--else if ($('#txtNameEn').val() == "" || $('#txtNameEn').val() == null) {
                ...
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemCodeRequred%>");
                $("#errordiv").fadeOut('slow');
                $('#txtCodeItem').focus();
                return false;
            }--%>
                ...
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemParentCategoryRequired%>");
                $("#errordiv").fadeOut('slow');
                $('#acParentCategory').focus();
                return false;
            }
            <%--else if ($(<%=ddlItemTypeItemeCard.ClientID%>).val() != null) {
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemTypeItemCardRequired%>");
                $("#errordiv").fadeOut('slow');
                $(<%=ddlItemTypeItemeCard.ClientID%>).focus();
                return false;
            }--%>
            else if ($('#txtCost').val() == "" || $('#txtCost').val() == null) {
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgDocUnitCostRequired%>");
                $("#errordiv").fadeOut('slow');
                $('#txtCost').focus();
                return false;
            }
            <%--else if ($('#txtLastPurchasePrice').val() == "" || $('#txtLastPurchasePrice').val() == null) {
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemLastPurchasePriceRequired%>");
                $("#errordiv").fadeOut('slow');
                ...
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemAveragePurchasePriceRequired%>");
                $("#errordiv").fadeOut('slow');
                ...
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemPriceUnitRequired%>");
                $("#errordiv").fadeOut('slow');
                $('#txtPriceUnite').focus();
                return false;
            }
                ...
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemMiSalePriceRequired%>");
                $("#errordiv").fadeOut('slow');
                ...
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgItemMinQtyRequired%>");
                $("#errordiv").fadeOut('slow');
                $('#txtMinQty').focus();
                return false;
            }--%>
            else if (<%=this.GetEnableEInvoice().ToString().ToLower()%>== true && (taxId == null || taxId == '' || taxId == "" || taxId == undefined)) {
                $("#errordiv").fadeIn();
                $("#viewerror").html("<%=Resources.Messages.MsgTaxRequired%>");
                $("#errordiv").fadeOut('slow');
                $('#txtMinQty').focus();
                return false;
            }
                ...
                var itemType = $(<%=ddlItemTypeItemeCard.ClientID%>).val();
                ...
                //    var priceRow = {
                //        'ID': id, 'PriceName_ID': 71, 'Price': $('#txtWholesalePrice').val(), 'UOM_ID': smallestUnitId
                //    };
                //    priceDataRows.push(priceRow);
                //var priceRow = {
                //    'ID': id, 'PriceName_ID': 108, 'Price': $('#txtSpecialPrice').val(), 'UOM_ID': smallestUnitId
                //};
                //priceDataRows.push(priceRow);
                ...
                $.post('../../api/Item/SaveItem', {
                    ...
                    PriceSource: priceDataRows, UnitSource: unitDataRows, RawMatSource: rawMatDataRows, WholesalePrice: $('#txtWholesalePrice').val(), SpecialPrice: $('#txtSpecialPrice').val()
                },
                    function (response) {
                        if (response.Code != 100) {
                            ...
                            $("#errordiv").fadeIn();
                            $("#viewerror").html(response.Message);
                            $("#errordiv").fadeOut('slow');
                            //hideModal('#UpdateDataModal');
                        }
                        else {
                            ...
                            $("#errordiv").fadeIn();
                            $("#viewerror").html(response.Message);
                            $("#errordiv").fadeOut('slow', function () { hideModal("#itemInfoModal"); });
                            //loadItems(true);
                            refreshProductList();
                            clearProductTools();
                        }
...
<body runat="server">
     <form id="form1" runat="server">    
        <div class="MainInvoiceStyleDiv">
                ...
                <div class="modal-dialog modal-xl">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="overflow: auto;">
                            <div class="alert alert-danger col-md-12" id="errordiv" style="display: none;">
                                    ...
                                    <div class="row grid-divider">
                                        ...
                                        <div class="col-md-3" style="margin-left:5px;">
                                            ...
                                            <div class="row col-padding">
                                                ...
                                                <input id="txtCodeItem" type="text" placeholder="<%=Resources.Labels.CodeItem %>" class="form-control" readonly />
                                            </div>  
                                            <div class="row col-padding">
                                        ...
                                        <div class="col-md-3" style="margin-left:5px;">                                     
                                            <div class="row col-padding">
                                                <label><%=Resources.Labels.Cost %><span style="color:red">*</span></label>
                                                <input id="txtCost" type="text" placeholder="<%=Resources.Labels.Cost %>" class="form-control" />
                                            </div>
                                            <div class="row col-padding">
                                                <label><%=Resources.Labels.Price %><span style="color:red">*</span></label>
                                                <input id="txtPriceUnite" type="text" placeholder="<%=Resources.Labels.Price %>" class="form-control" />
                                            </div>
                                          <div class="row col-padding">
                                                <label><%=Resources.Labels.WholesalePrice %><span style="color:red">*</span></label>
                                                <input id="txtWholesalePrice" type="text" placeholder="<%=Resources.Labels.WholesalePrice %>" class="form-control" />
                                            </div>
                                            <div class="row col-padding">
                                                <label><%=Resources.Labels.SpecialPrice %><span style="color:red">*</span></label>
                                                <input id="txtSpecialPrice" type="text" placeholder="<%=Resources.Labels.SpecialPrice %>" class="form-control" />
                                            </div>
                                            <div class="row col-padding">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-check row">
                                                <label class="form-check-label" for="chkIsUseTax">
                                                    <%{
                                                            if (this.GetEnableEInvoice() == true)
                                                            {
                                                            %>
                                                                <input type="checkbox" class="form-check-input" id="chkIsUseTax" checked="checked" />  
                                                            <%}
                                                                else
                                                                {
                                                            %>
                        ...
                        <div class="modal-footer">
                            <button type="button" id="btnSave" style="font-size: 20px; border-radius: 5px; margin: 10px; display: none;" class="btn btn-primary btn-lg"><%=Resources.Labels.Save %></button>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h4 id="itemName"></h4>
                            <h4 id="itemId"></h4>
                            <div class="alert col-md-12" id="deleteerrordiv" style="display: none;">
                                <span id="deleteviewerror"></span>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" id="btnDelete" class="btn btn-danger btn-lg"><%=Resources.Labels.Delete%></button>
            ...
            <!-- Modal -->
            <div class="modal fade" id="setTaxModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <strong><%=Resources.Labels.Tax %></strong>
                            <button type="button" class="close" data-bs-dismiss="modal">x</button>
                        </div>
                        <div class="modal-body">
                            <%--<h3><%=Resources.Labels.Tax %></h3>--%>
                            <div class="alert col-md-12" id="taxerrordiv" style="display: none;">
                                <span id="taxviewerror"></span>
                            </div>

                            <div class="row col-padding">
                                <div class="col-md-8 offset-md-2">
                                <label><%=Resources.Labels.Tax %></label>
                                <div id="acTaxForAll" class="dxComb"></div></div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" id="btnSetTax" class="btn btn-primary btn-lg"><%=Resources.Labels.Save%></button>
                            <button type="button" class="btn btn-success btn-lg" data-bs-dismiss="modal"><%=Resources.Labels.Close%></button>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                ...
                <div class="dx-viewport">
                    ...
                    <div class="row" style="margin-left: 20px; margin-right: 20px;">
                        <div class="col-md-12">
                            <div class="row">
                                <a href="#" class="col-md-2 btn btn-info" onclick="addProduct()"><%=Resources.Labels.AddNew %></a>
                                <div class="col-md-1"></div>
                                <a href="#setTaxModal" class="col-md-3 btn btn-info" 
                                    data-bs-toggle="modal" data-bs-target="#setTaxModal">تعديل الضريبة على كل الاصناف</a>
                    ...
                    <div class="col-md-3">
                        <div id="acCategorySearch" class="dxComb"></div>
                    </div>

                    <div class="col-md-2">
                        <asp:DropDownList ID="ddlItemTypeSearch" runat="server" AutoPostBack="false">
                    ...
                    <div class="col-md-3">
                        <div id="acItem" class="dxComb"></div>
                    </div>
                    ...
                    <input type="button" id="btnSearch" class="col-md-1 btn btn-primary" value="<%=Resources.Labels.Search%>" />
                </div>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">                     
                        <div id="searchDgvDiv" class=" col-md-12">
