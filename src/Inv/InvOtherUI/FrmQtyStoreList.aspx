<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrmQtyStoreList.aspx.cs" Inherits="Inv_InvOtherUI_FrmQtyStoreList" %>
...
<body>
    <form id="form1" runat="server">
        <div id="dgvDiv" runat="server">
            <asp:GridView runat="server" ID="gvQtyStoreList1" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ItemeBalanceStore" HeaderText="<%$Resources:Labels,Quantity %>"
                     ...
                     <asp:TemplateField HeaderText="<%$Resources:Labels,Select %>" HeaderStyle-HorizontalAlign="Center" ControlStyle-Width="50px" ControlStyle-Height="50px">
                        <ItemTemplate>                            
                                    ...
                                    <a href="#" onclick="itemQuantitySelected('<%=Request.QueryString["rowIndex"] %>','<%#Eval("ItemeBalanceStore")%>')">
        ...
        <div runat="server" id="lblDiv" class="alert alert-danger col-md-12">
            <span runat="server" id="lblError"><%=Resources.Messages.MsgNoAvailableQuantity %></span>
        </div>
    </form>
</body>
</html>
