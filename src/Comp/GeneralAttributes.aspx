<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="GeneralAttributes.aspx.cs" Inherits="Comp_GeneralAttributes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <asp:Panel ID="pnlSearch" CssClass="pnlSearch" runat="server" DefaultButton="btnSearch">
        ...
        <div class="content">
            <div class="form" style="width: 550px;">
                <asp:AutoComplete ID="acParentTypeSrch" ServiceMethod="GetGeneralAtt" LabelText="<%$Resources:Labels,Type %>"
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvAtts" GridViewStyle="BlueStyle" DataKeyNames="ID,Parent_ID,AttName"
        OnRowDeleting="gvAtts_RowDeleting" OnPageIndexChanging="gvAtts_PageIndexChanging"
        OnSelectedIndexChanging="gvAtts_SelectedIndexChanging">
        <Columns>
            <asp:BoundField DataField="ParentTypeName" HeaderText="<%$Resources:Labels,Type %>" />
            <asp:BoundField DataField="AttName" HeaderText="<%$Resources:Labels,Name %>" />
            <asp:BoundField DataField="AttNameEN" HeaderText="<%$Resources:Labels,NameEN %>" />
            <asp:TemplateField HeaderText="<%$ Resources:Labels, Edit %>">
                <ItemTemplate>
                    <asp:ImageButton ImageUrl="../images/edit_grid.gif" runat="server" CommandName="Select"
                        Visible='<%# !Convert.ToBoolean(Eval("IsSystem")) %>' />
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:Panel ID="pnlAdd" CssClass="pnlPopUp" runat="server" Width="280">
        ...
        <div class="content">
            <div class="form">
                <asp:AutoComplete ID="acParentType" ServiceMethod="GetGeneralAtt" LabelText="<%$Resources:Labels,Type %>"
                    runat="server" IsRequired="true" ValidationGroup="AddNew"></asp:AutoComplete>
                ...
                <asp:ABFTextBox ID="txtNameEN" CssClass="field" LabelText="<%$Resources:Labels,NameEN %>"
                    runat="server" IsRequired="true" ValidationGroup="AddNew"></asp:ABFTextBox>
            </div>
            <div style="clear: both;">
            </div>
