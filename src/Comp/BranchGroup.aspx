<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="BranchGroup.aspx.cs" Inherits="Comp_BranchGroup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvBrancheGroup" GridViewStyle="GrayStyle" DataKeyNames="ID,NameGroup"
        OnRowDeleting="gvBrancheGroup_RowDeleting" OnPageIndexChanging="gvBrancheGroup_PageIndexChanging"
        OnSelectedIndexChanging="gvBrancheGroup_SelectedIndexChanging">
        <Columns>

            <asp:BoundField DataField="NameGroup" HeaderText="<%$Resources:Labels,Name %>" />
    ...
    <asp:ModalPopupExtender ID="mpeCreateNew" runat="server" TargetControlID="lnkAddNew"
        ...
        BehaviorID="showPopUp" Y="350">
    </asp:ModalPopupExtender>
    <asp:Panel ID="pnlAdd" CssClass="pnlPopUp" runat="server" Width="310">
        <div class="tcat">
