<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="Areas.aspx.cs" Inherits="Sales_Areas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvAreas" GridViewStyle="BlueStyle" DataKeyNames="ID,Name"
        OnRowDeleting="gvAreas_RowDeleting" OnPageIndexChanging="gvAreas_PageIndexChanging"
        OnSelectedIndexChanging="gvAreas_SelectedIndexChanging">
        <Columns>
