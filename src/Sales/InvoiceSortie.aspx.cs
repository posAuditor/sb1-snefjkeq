...
public partial class Sales_InvoiceSortie : UICulturePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //if (databaseName.ToLower() == Constant.DBChoosed.ToLower())
                //{
                //    pnlCustomerMesure.Visible = true;
                //}
    ...
    private bool Save(bool IsApproving, System.Data.Common.DbTransaction trans)
    {
        ...
        byte EntryType = 3;
        int Serial_ID = DocSerials.InvoiceSortie.ToInt();
        ...
        if (!this.EditMode)
        {
            ...
            this.Invoice_ID = dc.usp_InvoiceDateDelivery_Insert(acBranch.Value.ToNullableInt(), ddlCurrency.SelectedValue.ToInt(), txtRatio.Text.ToDecimalOrDefault(), txtOperationDate.Text.ToDate(),
                                             ...
                                             lblGrossTotal.Text.ToDecimalOrDefault(), 0, null, txtUserRefNo.Text, this.DocRandomString, EntryType, SalesOrderID, acSalesRep.Value.ToNullableInt(), acCashAccount.Value.ToNullableInt(), acCustomerMesure.Value.ToNullableInt(), null, null,
                                              1, 0, string.Empty,string.Empty, string.Empty, string.Empty, string.Empty, string.Empty,"",null,string.Empty);
            ...
            //                                         approvedBY_ID, null, null, acAddress.Value.ToNullableInt(), acShipAddress.Value.ToNullableInt(), acPaymentAddress.Value.ToNullableInt(),
            //                                         acTelephone.Value.ToNullableInt(), acCostCenter.Value.ToNullableInt(), txtNotes.Text, lblTotal.Text.ToDecimal(), txtPercentageDiscount.Text.ToDecimalOrDefault(),
            //                                         txtCashDiscount.Text.ToDecimalOrDefault(), txtAdditionals.Text.ToDecimalOrDefault(), lblTotalDiscount.Text.ToDecimalOrDefault(), lblTotalTax.Text.ToDecimalOrDefault(), lblGrossTotal.Text.ToDecimalOrDefault(), txtFirstPaid.Text.ToDecimalOrDefault(), null, txtUserRefNo.Text, this.DocRandomString, EntryType, SalesOrderID, acSalesRep.Value.ToNullableInt(), acCashAccount.Value.ToNullableInt(), acCustomerMesure.Value.ToNullableInt());
            ...
            if (this.Invoice_ID > 0)
            {
                foreach (DataRow r in this.dtItems.Rows)
                {
                    ...
                    //Detail_ID = dc.usp_InvoiceDetailsWithDesciption_Insert(this.Invoice_ID, r["Store_ID"].ToInt(), r["Item_ID"].ToInt(), r["UnitCost"].ToDecimal(), r["Quantity"].ToDecimal(), r["Uom_iD"].ToInt(), r["Batch_ID"].ToNullableInt(), r["Tax_ID"].ToNullableInt(), r["PercentageDiscount"].ToDecimalOrDefault(), r["CashDiscount"].ToDecimalOrDefault(), r["TotalTax"].ToDecimalOrDefault(), r["Notes"].ToExpressString(), r["QtyInNumber"].ToDecimalOrDefault(), r["Capacity"].ToString(), r["ItemDescription"].ToString(), r["IDCodeOperation"].ToString(), r["Policy"].ToString(), r["InvoiceDate"].ToDate(), r["Capacities"].ToString(), false,false,null,false,false);
        ...
        else
        {
            ...
            //                                        lblTotalDiscount.Text.ToDecimalOrDefault(), lblTotalTax.Text.ToDecimalOrDefault(), lblGrossTotal.Text.ToDecimalOrDefault(), txtFirstPaid.Text.ToDecimalOrDefault(), txtUserRefNo.Text, this.DocRandomString, acSalesRep.Value.ToNullableInt(), acCashAccount.Value.ToNullableInt());
            ...
            int Result = dc.usp_InvoiceDelivery_Update(this.Invoice_ID, acBranch.Value.ToNullableInt(), ddlCurrency.SelectedValue.ToInt(), txtRatio.Text.ToDecimalOrDefault(), txtOperationDate.Text.ToDate(),
                                                 ...
                                                 null, null, acAddress.Value.ToNullableInt(), acShipAddress.Value.ToNullableInt(), acPaymentAddress.Value.ToNullableInt(), acTelephone.Value.ToNullableInt(),
                                                 acCostCenter.Value.ToNullableInt(), txtNotes.Text, lblTotal.Text.ToDecimal(), txtPercentageDiscount.Text.ToDecimalOrDefault(), txtCashDiscount.Text.ToDecimalOrDefault(), txtAdditionals.Text.ToDecimalOrDefault(),
                                                 lblTotalDiscount.Text.ToDecimalOrDefault(), lblTotalTax.Text.ToDecimalOrDefault(), lblGrossTotal.Text.ToDecimalOrDefault(), 0, txtUserRefNo.Text, this.DocRandomString, acSalesRep.Value.ToNullableInt(), acCashAccount.Value.ToNullableInt(), null, null,
                                                 1, 0, string.Empty,string.Empty, string.Empty, string.Empty, string.Empty, string.Empty,string.Empty);
        ...
        UserMessages.Message(null, Resources.UserInfoMessages.OperationSuccess + Serial, PageLinks.InvoiceSortie + Request.PathInfo + "?ID=" + this.Invoice_ID.ToExpressString(), PageLinks.InvoicesSortieList, PageLinks.InvoiceSortie + Request.PathInfo);
        return true;
    }
    ...
    private void Calculate()
    {
        ...
        foreach (DataRow r in this.dtItems.Rows)
        {
            ...
            r["TotalCostBeforTax"] = (r["UnitCost"].ToDecimalOrDefault() * r["Quantity"].ToDecimal()) - (r["PercentageDiscount"].ToDecimal() * r["Total"].ToDecimal() * 0.01m) - r["CashDiscount"].ToDecimal(); ;
            ...
            r["GrossTotal"] = (r["UnitCostEvaluate"].ToDecimalOrDefault() * r["Quantity"].ToDecimal() - ItemDiscount + r["TotalTax"].ToDecimal()).ToString(NbrHashNeerDecimal).ToDecimalOrDefault(); //- ItemDiscount //+ r["TotalTax"].ToDecimal();
            decimal gTotalRow = (
                                r["UnitCostEvaluate"].ToDecimalOrDefault() * r["Quantity"].ToDecimal()
                              - ItemDiscount
                              + r["TotalTax"].ToDecimal()).ToString(NbrHashNeerDecimal).ToDecimalOrDefault();
            ...
            this.GrossTotal += r["Total"].ToDecimal(); //- pDisc - ItemDiscount + r["TotalTax"].ToDecimal();
    ...
    protected void btnCancelApprove_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //trans.Commit();
            UserMessages.Message(null, Resources.UserInfoMessages.OperationSuccess, PageLinks.InvoiceSortie + "?ID=" + this.Invoice_ID.ToExpressString(), PageLinks.InvoicesSortieList, PageLinks.InvoiceSortie);
