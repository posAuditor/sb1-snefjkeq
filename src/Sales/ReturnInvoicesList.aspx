<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ReturnInvoicesList.aspx.cs" Inherits="Sales_ReturnInvoicesList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvReturnInvoicesList" GridViewStyle="GrayStyle" DataKeyNames="ID,Branch_ID"
        OnSelectedIndexChanging="gvReturnInvoicesList_SelectedIndexChanging" OnPageIndexChanging="gvReturnInvoicesList_PageIndexChanging">
        <Columns>
            ...
            <asp:TemplateField HeaderText="<%$ Resources:Labels, Edit %>">
                <ItemTemplate>
                    <asp:HyperLink runat="server" NavigateUrl='<%# String.Format("ReturnInvoice.aspx?ID={0}", Eval("ID")) %>'
