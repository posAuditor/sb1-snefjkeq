<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="QuotaList.aspx.cs" Inherits="Sales_QuotaList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
            ...
            <div class="form" style="width: 550px;">
                <div class="right_col">
                    ...
                    <div runat="server" id="divHasBill">
                        ...
                        <asp:DropDownList ID="ddlIsHasBill" runat="server" Visible="false">
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvInvoicesList" GridViewStyle="GrayStyle" DataKeyNames="ID,GrossTotalAmount,Serial,Branch_ID"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="DocStatus" Visible="false" HeaderText="<%$Resources:Labels,Status %>" />
            ...
            <asp:TemplateField HeaderText="">
                <ItemTemplate>
                     <asp:HyperLink runat="server" NavigateUrl='<%# String.Format("{1}?Qt_ID={0}", Eval("ID"),XPRESS.Common.PageLinks.InvoiceShortcut ) %>'
                        Text="تحويل لفاتورة" />
                </ItemTemplate>
            </asp:TemplateField>
