<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="OutputList.aspx.cs" Inherits="Sales_OutputList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <asp:ABFGridView runat="server" ID="gvInvoicesList" GridViewStyle="GrayStyle" DataKeyNames="ID,GrossTotalAmount,CollectedAmount,Serial,Branch_ID"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="SerialRelated" HeaderText="<%$Resources:Labels,Serial %>" />
            <asp:TemplateField HeaderText="<%$ Resources:Labels, Edit %>">
                <ItemTemplate>
                    <asp:HyperLink runat="server" NavigateUrl='<%# String.Format("{1}?Output_ID={0}", Eval("ID"),"~/Sales/InvoiceOutput.aspx" ) %>'
