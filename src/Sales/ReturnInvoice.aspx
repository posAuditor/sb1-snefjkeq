<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="ReturnInvoice.aspx.cs" Inherits="Sales_ReturnInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    <div class="MainInvoiceStyleDiv">
        ...
        <div class="InvoiceHeader">
            ...
            <asp:Label runat="server" Visible="false" Style="padding-left: 10px; padding-right: 10px; font-weight: bold;"><%=Resources.Labels.ReturnInvoice %></asp:Label>

            <div runat="server" visible="false" id="divFromInvNo" style="display: inline-block;">
                <span>
                    <%=Resources.Labels.FromInvoiceNo%></span>:
                <asp:Label ID="lblFromInvoiceNo" runat="server" Font-Bold="true" Text=""></asp:Label>
            </div>
            ...
            <div class="Row">
                <div class="Column">
                    ...
                    <asp:AutoComplete runat="server" ID="acStore" ServiceMethod="GetStores" LabelText="<%$Resources:Labels,Store %>"
                        IsRequired="true" ValidationGroup="AddItem" AutoPostBack="true" OnSelectedIndexChanged="acStore_SelectedIndexChanged"></asp:AutoComplete>
                ...
                <div class="Column">
                    ...
                    <asp:ABFTextBox ID="txtRatio" Style="display: none" runat="server" ValidationGroup="Save" LabelText="<%$Resources:Labels,Ratio %>" VisibleText="false"
                    ...
                    <asp:AutoComplete runat="server" style="display: none;" ID="acCashAccount" ServiceMethod="GetChartOfAccountsCheledronly" Visible="false"
        ...
        <div class="InvoiceSection">
            ...
            <div class="container">
                <asp:ABFTextBox ID="txtBarcode" runat="server" LabelText="<%$Resources:Labels,Barcode %>" TabIndex="0" Style="background-color: #eadbf5; text-align: center; font-size: 22px; font-weight: bold"
                                ...
                                <div>
                                    <table class="grdWoutHeader11" cellspacing="0" cellpadding="0" style="border-collapse: collapse;">
                                            ...
                                            <tr class="grdWoutHeader_row">
                                                ...
                                                <td class="colWLarge">
                                                    <asp:AutoComplete runat="server" ID="acItem" ServiceMethod="GetItems" ValidationGroup="AddItem"
                                                        ...
                                                        LabelText="<%$Resources:Labels,Item %>" VisibleText="false" CssClass="cls" TabIndex="1" onkeyup="return focusOnNext(event, 'cph_txtAmount')" Style="background-color: transparent; border-radius: 0px!important"></asp:AutoComplete>
                                                </td>
                                                <td class="colW">
                                                ...
                                                <td class="colW">
                                                    <asp:ABFTextBox ID="txtQty" runat="server" LabelText="<%$Resources:Labels,Quantity %>" TabIndex="3"
                                                        MinValue="0.001" DataType="Decimal" AutoPostBack="true" OnTextChanged="txtQty_TextChanged" IsRequired="true" ValidationGroup="AddItem" VisibleText="false" CssClass="cls" onkeyup="return focusOnNext(event, 'cph_txtAmount')" Style="background-color: transparent; border-radius: 0px!important"></asp:ABFTextBox></td>

                                                <td class="colW">
                                                    <asp:ABFTextBox ID="txtCost" runat="server" LabelText="<%$Resources:Labels,Price %>" TabIndex="4"
                                                        MinValue="0" DataType="Decimal" IsRequired="true" AutoPostBack="true" OnTextChanged="txtQty_TextChanged" ValidationGroup="AddItem" VisibleText="false" CssClass="cls" onkeyup="return focusOnNext(event, 'cph_txtAmount')" Style="background-color: transparent; border-radius: 0px!important"></asp:ABFTextBox></td>

                                                <td class="colW">

                                                    <asp:ABFTextBox ID="txtItemPercentageDiscount" runat="server" AutoPostBack="true" OnTextChanged="txtQty_TextChanged" LabelText="<%$Resources:Labels,PercentageDiscount %>" TabIndex="5"
                                                ...
                                                <td class="colW">
                                                    <asp:ABFTextBox ID="txtItemCashDiscount" runat="server" AutoPostBack="true" OnTextChanged="txtQty_TextChanged" LabelText="<%$Resources:Labels,CashDiscount %>" TabIndex="6"
                                                        MinValue="0" DataType="Decimal" ValidationGroup="AddItem" VisibleText="false" CssClass="cls" onkeyup="return focusOnNext(event, 'cph_txtAmount')" Style="background-color: transparent; border-radius: 0px!important"></asp:ABFTextBox>
                                                </td>
                                                <td class="colW">
                                      ...
                                      <i class="btnShartcatInvoice demo-icon icon-plus" style="font-size: 20px; padding-top: 10px; color: black!important"></i>
                                                ...
                                                <td class="colSmall" style="color: black">  <asp:Image ID="Image1" runat="server" Width="34" ImageUrl="../images/black.gif" /></td>
                                                <td class="colSmall" style="color: black">  <asp:Image ID="Image2" runat="server" Width="34" ImageUrl="../images/black.gif" /></td>
                                                <%-- </tr>
                            ...
                            <td colspan="11">
                                ...
                                <asp:AuditorGridView runat="server" ID="gvItems" GridViewStyle="GrayStyle" DataKeyNames="ID"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField ControlStyle-CssClass="colW" ItemStyle-CssClass="colW" DataField="Quantity" HeaderText="<%$Resources:Labels,Quantity %>"
                                            DataFormatString="{0:0.####}" />

                                        <asp:BoundField ControlStyle-CssClass="colW" ItemStyle-CssClass="colW" DataField="UnitCostEvaluate" HeaderText="<%$Resources:Labels,Price %>" DataFormatString="{0:0.########}" />


                                        <%-- <asp:BoundField ControlStyle-CssClass="colW" ItemStyle-CssClass="colW" DataField="UnitCost" HeaderText="<%$Resources:Labels,Price %>" DataFormatString="{0:0.####}" />--%>
                        ...
                        <tr>
                            ...
                            <th class="colWx">
                                <asp:ABFTextBox ID="txtAdditionals" runat="server" LabelText="<%$Resources:Labels,Additionals %>"
                                    ...
                                    ValidationGroup="Save" DataType="Decimal" IsHideable="true"></asp:ABFTextBox></th>
                            <th class="colWx">
                                <asp:ABFTextBox ID="txtFirstPaid" runat="server" LabelText="<%$Resources:Labels,FirstPaid %>" Visible="false"
        ...
        <div class="InvoiceSection" style="display: none;">
            ...
            <br />
            <span>
                <%=Resources.Labels.CustomerSoldQty %>: </span>
            <asp:Label ID="lblCustomerSoldQty" runat="server" Text=""></asp:Label>
            <div style="clear: both">
            </div>
            ...
            <asp:Panel ID="pnlAddItem" runat="server" DefaultButton="btnAddItem">
                <div class="form" style="width: 90%; margin: auto;">
                    <div class="right_col">
                        ...
                        <asp:Panel runat="server" Visible="false">
                            <asp:AutoComplete runat="server" ID="acItemDescribed" ServiceMethod="GetItemsDescribed" ValidationGroup="AddItem"
                                AutoPostBack="true"
