<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="Invoice.aspx.cs" Inherits="Sales_Invoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    <div class="MainInvoiceStyleDiv">
                ...
                <div class="form" style="margin: auto; width: 90%;">
                    <div class="right_col">
                        ...
                        <asp:ABFTextBox ID="txtQty" runat="server" LabelText="<%$Resources:Labels,Quantity %>"
                            MinValue="0.001" DataType="Decimal" Text="1" IsRequired="true" ValidationGroup="AddItem"></asp:ABFTextBox>
                    ...
                    <div class="left_col">
                        <asp:AutoComplete runat="server" ID="acPriceName" ServiceMethod="GetItemPriceNames"
                            ...
                            AutoPostBack="true" IsHideable="true"></asp:AutoComplete>
                        <asp:ABFTextBox ID="txtCost" runat="server" LabelText="<%$Resources:Labels,Price %>"
                        ...
                        <asp:ABFTextBox ID="txtPolicy" IsRequired="True" runat="server" LabelText="<%$Resources:Labels,Policy %>"
                            MinValue="0" DataType="FreeString" ValidationGroup="AddItem" IsHideable="true"></asp:ABFTextBox>

                        <asp:ABFTextBox ID="txtCode" IsRequired="True" runat="server" LabelText="<%$Resources:Labels,Code %>"
                            MinValue="0" DataType="FreeString" ValidationGroup="AddItem" IsHideable="true"></asp:ABFTextBox>

                        <asp:ABFTextBox ID="txtInvoiceDate" runat="server" ValidationGroup="AddItem" LabelText="<%$Resources:Labels,DateRequest %>"
            ...
            <asp:ABFGridView runat="server" ID="gvItems" GridViewStyle="GrayStyle" DataKeyNames="ID"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ExpirationDate"   HeaderText="<%$Resources:Labels,ExpirationDate %>" ItemStyle-CssClass="BatchCol "
                        DataFormatString="{0:d/M/yyyy}" />--%>
                    <asp:BoundField DataField="UnitCost" HeaderText="<%$Resources:Labels,Price %>" DataFormatString="{0:0.########}" />
                    ...
                    <asp:BoundField DataField="CashDiscount" HeaderText="<%$Resources:Labels,CashDiscount %>"
                        DataFormatString="{0:0.########}" />
                    <asp:BoundField DataField="TaxPercentageValue" HeaderText="<%$Resources:Labels,Tax %>"
                        DataFormatString="{0:0.########}" ItemStyle-CssClass="TaxCol" />
        ...
        <div class="InvoiceSection">
            ...
            <br />
            <br />
            <div class="form" style="margin: auto; width: 700px;">
                <div class="right_col">
