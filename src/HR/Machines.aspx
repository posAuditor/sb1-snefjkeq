<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="Machines.aspx.cs" Inherits="HR_Machines" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvMachines" GridViewStyle="BlueStyle" DataKeyNames="ID,MachineName"
        OnRowDeleting="gvMachines_RowDeleting" OnPageIndexChanging="gvMachines_PageIndexChanging"
        OnSelectedIndexChanging="gvMachines_SelectedIndexChanging">
        <Columns>
            <asp:BoundField DataField="MachineName" HeaderText="<%$Resources:Labels,Name %>" />
            <asp:BoundField DataField="IPAddress" HeaderText="<%$Resources:Labels,IPAddress %>" />
            <asp:BoundField DataField="Port" HeaderText="<%$Resources:Labels,Port %>" />
        ...
        <div class="content">
            ...
            <div class="form">
                <div class="col_right">
                    ...
                    <asp:ABFTextBox ID="txtIPAddress" CssClass="field" LabelText="<%$Resources:Labels,IPAddress %>"
                        runat="server" IsRequired="true" ValidationGroup="AddNew"></asp:ABFTextBox>
                    <asp:ABFTextBox ID="txtPort" CssClass="field" LabelText="<%$Resources:Labels,Port %>"
                        runat="server" IsRequired="true" ValidationGroup="AddNew" DataType="Int"></asp:ABFTextBox>

                </div>
                <div class="col_left">
                    <asp:ABFTextBox ID="txtMachinePassword" CssClass="field" LabelText="<%$Resources:Labels,Password %>"
                        runat="server" ValidationGroup="AddNew" TextMode="Password" DataType="Int"></asp:ABFTextBox>
                    <label>
                        <%=Resources.Labels.Model %></label>
                    <asp:DropDownList ID="ddlModel" runat="server" >
                        <asp:ListItem Text="<%$ Resources:Labels,BlackAndWhite %>" Value="0" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="<%$ Resources:Labels,Colored %>" Value="1"></asp:ListItem>
                    </asp:DropDownList>
                </div>
