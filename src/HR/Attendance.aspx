<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="Attendance.aspx.cs" Inherits="HR_Attendance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
        ...
        <div class="content">
            <div class="form" style="width: 550px;">
                <div class="right_col">
                    ...
                    <asp:ABFTextBox ID="txtFromDateSrch" CssClass="field" LabelText="<%$Resources:Labels,DateFrom %>" IsDateFiscalYearRestricted="false"
                        runat="server" ValidationGroup="search" DataType="Date"></asp:ABFTextBox>
                    <asp:ABFTextBox ID="txtToDateSrch" CssClass="field" LabelText="<%$Resources:Labels,DateTo %>" IsDateFiscalYearRestricted="false"
                        runat="server" ValidationGroup="search" DataType="Date"></asp:ABFTextBox>
                </div>
                <div class="left_col">
    ...
    <asp:ABFGridView runat="server" ID="gvAttendance" GridViewStyle="BlueStyle" DataKeyNames="ID,ContactName"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="CheckInTime" HeaderText="<%$Resources:Labels,CheckInTime %>"
                DataFormatString="{0:hh:mm tt}" />
            <asp:BoundField DataField="CheckOutTime" HeaderText="<%$Resources:Labels,CheckOutTime %>"
                DataFormatString="{0:hh:mm tt}" />
    ...
    <asp:Panel ID="pnlAdd" CssClass="pnlPopUp" runat="server" Width="280">
        ...
        <div class="content">
            <div class="form">
                ...
                <asp:ABFTextBox ID="txtDate" CssClass="field" LabelText="<%$Resources:Labels,Date %>" IsDateFiscalYearRestricted="false"
                    runat="server" IsRequired="true" ValidationGroup="AddNew" DataType="Date"></asp:ABFTextBox>
                <asp:ABFTextBox ID="txtCheckInTime" CssClass="field" LabelText="<%$Resources:Labels,Time %>"
                    Width="160" runat="server" IsRequired="true" ValidationGroup="AddNew" DataType="Time"></asp:ABFTextBox>
                <asp:DropDownList ID="ddlCheckInTime" runat="server" Width="50" Style="display: inline;">
                    <asp:ListItem Text="<%$Resources:Labels,AM %>" Value="AM"></asp:ListItem>
                    <asp:ListItem Text="<%$Resources:Labels,PM %>" Value="PM"></asp:ListItem>
                </asp:DropDownList>
                <asp:ABFTextBox ID="txtCheckOutTime" CssClass="field" LabelText="<%$Resources:Labels,CheckOutTime %>"
                    Width="160" runat="server" ValidationGroup="AddNew" DataType="Time"></asp:ABFTextBox>
                <asp:DropDownList ID="ddlCheckOutTime" runat="server" Width="50" Style="display: inline;">
                    <asp:ListItem Text="<%$Resources:Labels,AM %>" Value="AM"></asp:ListItem>
                    <asp:ListItem Text="<%$Resources:Labels,PM %>" Value="PM"></asp:ListItem>
                </asp:DropDownList>
            </div>
