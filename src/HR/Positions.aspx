<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="Positions.aspx.cs" Inherits="HR_Positions" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvPositions" GridViewStyle="BlueStyle" DataKeyNames="ID,Name"
        OnRowDeleting="gvPositions_RowDeleting" OnPageIndexChanging="gvPositions_PageIndexChanging"
        OnSelectedIndexChanging="gvPositions_SelectedIndexChanging">
        <Columns>
