<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="PayrollAdd.aspx.cs" Inherits="HR_PayrollAdd" %>
            ...
            <ContentTemplate>
                ...
                <asp:ABFGridView runat="server" ID="gvPayRoll" GridViewStyle="BlueStyle" DataKeyNames="ID,Contact_ID,ContactName,Department_ID,DepartmentName,GrossTotal,Month,Year,DocStatus_ID"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, OverTime %>" Visible="false">
                            <ItemTemplate>
                                <asp:ABFTextBox ID="txtOverTime" CssClass="field" LabelText="<%$Resources:Labels,OverTime %>" Width="100"
                                    AutoPostBack="true" runat="server" IsRequired="true"
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, OverTime %>">
                            <ItemTemplate>
                                <asp:ABFTextBox ID="txtOverTimeAdd" CssClass="field" LabelText="<%$Resources:Labels,OverTime %>" Width="100"
                                    OnTextChanged="txtOverTimeAdd_TextChanged" AutoPostBack="true" runat="server" IsRequired="true"
                                    ValidationGroup="AddNew" DataType="Decimal" MinValue="0" VisibleText="false"></asp:ABFTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="إجمالي الاضافي">
                            <ItemTemplate>
                                <asp:ABFTextBox ID="txtOverTimeValueAdd" OnTextChanged="txtOverTimeValueAdd_TextChanged" CssClass="field" LabelText="<%$Resources:Labels,OverTimeValue %>"
                                    runat="server" IsRequired="true" ValidationGroup="AddNew" DataType="Decimal" Width="100"
                                    AutoPostBack="true" MinValue="0" VisibleText="false"></asp:ABFTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="<%$ Resources:Labels, OverTimeValue %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, DayOffWork %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels,DayOffWorkValue   %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, Delay  %>" Visible="false">
                            <ItemTemplate>
                                <asp:ABFTextBox ID="txtDelay" CssClass="field" LabelText="<%$Resources:Labels,Delay %>"
                                    AutoPostBack="true" runat="server" IsRequired="true" Width="100"
                                    ValidationGroup="AddNew" DataType="Decimal" MinValue="0" VisibleText="false"></asp:ABFTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, DelayValue  %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels,Absence   %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels,AbsenceValue   %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, Excuse  %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, ExcuseValue  %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, DeducatedWorkDays  %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels,DeducatedWorkDaysValue   %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, DeducatedDaysOff  %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, DeducatedDaysOffValue  %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, Incentives  %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, Allowances  %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels,Taxes   %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, Insurance  %>" Visible="false">
                            <ItemTemplate>
                                <asp:ABFTextBox ID="txtInsurance" CssClass="field" LabelText="<%$Resources:Labels,Insurance %>"
                                    runat="server" IsRequired="true" ValidationGroup="AddNew" DataType="Decimal" Width="100"
                                    Enabled="False" AutoPostBack="true" MinValue="0" VisibleText="false"></asp:ABFTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="<%$ Resources:Labels,HRLoan   %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels,Sancations   %>" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="مكافئات - زيادات أخرى" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, OtherDeducations  %>" Visible="false">
                            <ItemTemplate>
                    ...
                    <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="<%$ Resources:Labels, Notes  %>">
                            <ItemTemplate>
                                <asp:ABFTextBox ID="txtNotes" CssClass="field" LabelText="<%$Resources:Labels,Notes %>" Width="200"
                                    runat="server" ValidationGroup="AddNew" VisibleText="false"></asp:ABFTextBox>
                            </ItemTemplate>
                        </asp:TemplateField>

                        <asp:TemplateField HeaderText="الاجمالي" Visible="false">
                            <ItemTemplate>
                        ...
                        <asp:TemplateField HeaderText="الخصومات" Visible="false">
                            <ItemTemplate>
