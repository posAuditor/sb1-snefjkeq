<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="Departments.aspx.cs" Inherits="HR_Departments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph" runat="Server">
    ...
    <br />
    <br />
    <asp:ABFGridView runat="server" ID="gvDepartments" GridViewStyle="BlueStyle" DataKeyNames="ID,Name"
        OnRowDeleting="gvDepartments_RowDeleting" OnPageIndexChanging="gvDepartments_PageIndexChanging"
        OnSelectedIndexChanging="gvDepartments_SelectedIndexChanging">
        <Columns>
            <asp:BoundField DataField="Name" HeaderText="<%$Resources:Labels,Name %>" />
            <asp:BoundField DataField="ParentName" HeaderText="<%$Resources:Labels,ParentDepartment %>" />
    ...
    <asp:Panel ID="pnlAdd" CssClass="pnlPopUp" runat="server" Width="280">
        ...
        <div class="content">
            <div class="form">
                ...
                <asp:AutoComplete ID="acParentDepartment" ServiceMethod="GetHRDepartments" LabelText="<%$Resources:Labels,ParentDepartment %>"
