<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.master"
    AutoEventWireup="true" CodeFile="Expenses.aspx.cs" Inherits="DocCredit_Expenses" %>
            ...
            <div class="form" style="width: 550px;">
                <div class="right_col">
                    ...
                    <asp:AutoComplete runat="server" ID="acExpenseName" ServiceMethod="GetGeneralAtt" AutoCompleteWidth="230"
                        LabelText="<%$Resources:Labels,Name %>" IsRequired="true" ValidationGroup="AddNew"></asp:AutoComplete>
